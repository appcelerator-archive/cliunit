...
/**
 * attempt to remove any control characters out of the output
 */
function stripcc(value){
	return value.replace(/[\x00-\x1F\x7F-\x9F]/g, function(value){
		// these are OK, others aren't
		if (/[\n\t\r]/.test(value)) {
			return value;
		}
		return '';
